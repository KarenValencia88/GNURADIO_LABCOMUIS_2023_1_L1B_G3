...
class multiplexaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._Am_range = Range(0, 50, 100e-3, 1, 200)
        ...
        self.analog_sig_source_x_0_2 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fm, Am, 0, 0)
        self.analog_sig_source_x_0_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fm, Am, 0, 0)
    ...
    def set_D3(self, D3):
        self.D3 = D3
        self.blocks_delay_0_0.set_dly(int(self.D3))
