...
class Lab2_PartA_L1B(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab2_PartA_L1B", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab2_PartA_L1B")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab2_PartA_L1B")
...
def main(top_block_cls=Lab2_PartA_L1B, options=None):
