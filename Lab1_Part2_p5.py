...
class Lab1_Part2_p5(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "LAB1_Part2_p5", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("LAB1_Part2_p5")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab1_Part2_p5")
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcom/lab_comu_I_L1B/gitana_williecolon.wav', True)
...
def main(top_block_cls=Lab1_Part2_p5, options=None):
