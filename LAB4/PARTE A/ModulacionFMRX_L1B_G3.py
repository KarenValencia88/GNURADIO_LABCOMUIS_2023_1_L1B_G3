...
# Title: Demodulaciòn de emisoras
# Author: labcom
# Copyright: L1B_G3
...
class ModulacionFMRX_L1B_G3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Demodulaciòn de emisoras", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Demodulaciòn de emisoras")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ModulacionFMRX_L1B_G3")
...
def main(top_block_cls=ModulacionFMRX_L1B_G3, options=None):
