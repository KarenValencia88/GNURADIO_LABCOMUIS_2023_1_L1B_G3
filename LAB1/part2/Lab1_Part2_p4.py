...
class Lab1_Part2_p4(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "LAB1_Part2_p4", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("LAB1_Part2_p4")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab1_Part2_p4")
        ...
        self.connect((self.analog_sig_source_x_0_1, 0), (self.rational_resampler_xxx_2, 0))
...
def main(top_block_cls=Lab1_Part2_p4, options=None):
